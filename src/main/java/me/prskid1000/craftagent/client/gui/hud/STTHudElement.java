package me.prskid1000.craftagent.client.gui.hud;
 ...
 * {@link me.prskid1000.craftagent.client.keybind.STTKeybind}
 */
public class STTHudElement implements HudRenderCallback {
    ...
    public void onHudRender(DrawContext drawContext, RenderTickCounter renderTickCounter) {
        if (isActive) {
            ...
            drawContext.drawTexture(RenderPipelines.GUI_TEXTURED, Identifier.of(MOD_ID, "stt-background.png"),
                    screenCenter - 40, 20,
                    80, 20,
                    0, 0,
                    80, 20, 80, 20);
            drawContext.drawTexture(RenderPipelines.GUI_TEXTURED, Identifier.of(MOD_ID, "icon.png"),
                    screenCenter - 35, 25,
                    9, 9,
                    0, 0,
                    55, 55, 55, 55);
